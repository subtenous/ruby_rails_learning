def display_current_inventory(inventory_list)
  ...
  inventory_list.each {|item, quantity| puts "Item: #{item} quantity: #{quantity}"}
end

display_current_inventory({milk: 3, bread: 5, chicken: 1,})
...
display_guess_order(["england", "spain", "portugal", "england", "spain"])
